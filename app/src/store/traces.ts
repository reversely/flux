...
function traceOf(payload: unknown): {
  model?: string;
  inferenceMs?: number;
  tokensIn?: number;
  tokensOut?: number;
  ...
  return {
    ...
    tokensIn: typeof trace.tokens_in === 'number' ? trace.tokens_in : undefined,
    tokensOut: typeof trace.tokens_out === 'number' ? trace.tokens_out : undefined,
  };
}
